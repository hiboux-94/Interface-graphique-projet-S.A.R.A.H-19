# Interface-graphique-projet-S.A.R.A.H-19
...
Cette interface graphique différente des autres contient :
...
Plusieurs fichiers "Images" => Plusieurs images au format png modifiables en éditant le fichier "fichier".ini

Plusieurs sous répertoires à ajouter par la suite (voir Add-On) pour superposer une interface graphique animée.
