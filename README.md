...
<p>Vous trouverez sur ce dosssier l'interface graphique de base modifiable, les interfaces superposables seront ajoutées sous d'autres répertoires de mon Github sous forme d'add-on avec un mode d'emploi dédié.</b></p>
